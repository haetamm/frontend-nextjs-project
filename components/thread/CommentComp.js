            ...
            <article className="p-6 mb-6 text-base bg-white rounded-lg">
                <footer className="flex justify-between items-center mb-2">
                    ...
                    <div className="dropdown dropdown-left">
                        ...
                        <>
                            <ul onClick={handleModalOpen} tabIndex={0} className="dropdown-content mr-2 menu p-1 shadow bg-base-100 rounded-md w-[7rem]">
                                <li><a>Hapus</a></li>
                            </ul>
                            <Modal
                                title="Peringatan!"
                                body="Komentar ini akan dihapus?"
                                visible={modalVisible}
                                onClose={handleModalClose}
                                handle={ loggedIn ? (e) => handleDeleteComment(e) : undefined }
                            ></Modal>
