import style from '../../src/styles/welcomcomp.module.css';
  ...
  return (
    <>
        <section className="bg-slate-350 dark:bg-gray-900 mt-10">
            <div className="grid max-w-screen-xl px-4 pt-10 pb-4 mx-auto lg:gap-8 xl:gap-0 lg:py-5 lg:grid-cols-12">
                    ...
                    <div className="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                        ...
                        <a href="#" className="inline-flex items-center justify-center w-full px-5 py-3 mb-2 mr-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:w-auto focus:outline-none hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                            <svg className="w-4 h-4 mr-2" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 300" width="1667" height="2500">
                                <path id="path0_fill" className={style.st0} d="M50 300c27.6 0 50-22.4 50-50v-50H50c-27.6 0-50 22.4-50 50s22.4 50 50 50z"/>
                                <path id="path1_fill" className={style.st1} d="M0 150c0-27.6 22.4-50 50-50h50v100H50c-27.6 0-50-22.4-50-50z"/>
                                <path id="path1_fill_1_" className={style.st2} d="M0 50C0 22.4 22.4 0 50 0h50v100H50C22.4 100 0 77.6 0 50z"/>
                                <path id="path2_fill" className={style.st3} d="M100 0h50c27.6 0 50 22.4 50 50s-22.4 50-50 50h-50V0z"/>
                                <path id="path3_fill" className={style.st4} d="M200 150c0 27.6-22.4 50-50 50s-50-22.4-50-50 22.4-50 50-50 50 22.4 50 50z"/>
                            </svg> 
                            Get Started
                        </a>
                    </div>
